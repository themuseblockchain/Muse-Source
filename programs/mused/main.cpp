...
int main(int argc, char** argv) {
   muse::plugin::initialize_plugin_factories();
   ...
   try {
      ...
      for( const std::string& plugin_name : muse::plugin::get_available_plugins() )
         node->register_abstract_plugin( muse::plugin::create_plugin( plugin_name ) );
