...
target_link_libraries( {plugin_provider}_{plugin_name} muse_app muse_chain fc graphene_db )
...
{{
   public:
      {plugin_name}_api( const muse::app::api_context& ctx );
...
class {plugin_name}_plugin : public muse::app::plugin
{{
   public:
      {plugin_name}_plugin();
...
{{
   public:
      {plugin_name}_api_impl( muse::app::application& _app );
...
{plugin_name}_api_impl::{plugin_name}_api_impl( muse::app::application& _app ) : app( _app )
{{}}
...
{plugin_name}_api::{plugin_name}_api( const muse::app::api_context& ctx )
{{
...
MUSE_DEFINE_PLUGIN( {plugin_name}, {plugin_provider}::plugin::{plugin_name}::{plugin_name}_plugin )
""",
}
...
def main(argv):
    ...
    parser.add_argument("provider", help="Name of plugin provider (muse for plugins developed by Muse)")
