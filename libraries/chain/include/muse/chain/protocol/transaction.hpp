...
FC_REFLECT( muse::chain::transaction, (ref_block_num)(ref_block_prefix)(expiration)(operations)(extensions) )
FC_REFLECT_DERIVED( muse::chain::signed_transaction, (muse::chain::transaction), (signatures) )
FC_REFLECT_DERIVED( muse::chain::annotated_signed_transaction, (muse::chain::signed_transaction), (transaction_id)(block_num)(transaction_num) )
FC_REFLECT_DERIVED( muse::chain::processed_transaction, (muse::chain::signed_transaction), (operation_results)); 
