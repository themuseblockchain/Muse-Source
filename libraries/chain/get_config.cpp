...
fc::variant_object get_config()
{
   ...
   result["MUSE_APR_PERCENT_MULTIPLY_PER_BLOCK"] = MUSE_APR_PERCENT_MULTIPLY_PER_BLOCK;
   result["MUSE_APR_PERCENT_MULTIPLY_PER_HOUR"] = MUSE_APR_PERCENT_MULTIPLY_PER_HOUR;
   result["MUSE_APR_PERCENT_MULTIPLY_PER_ROUND"] = MUSE_APR_PERCENT_MULTIPLY_PER_ROUND;
   result["MUSE_APR_PERCENT_SHIFT_PER_BLOCK"] = MUSE_APR_PERCENT_SHIFT_PER_BLOCK;
   result["MUSE_APR_PERCENT_SHIFT_PER_HOUR"] = MUSE_APR_PERCENT_SHIFT_PER_HOUR;
   result["MUSE_APR_PERCENT_SHIFT_PER_ROUND"] = MUSE_APR_PERCENT_SHIFT_PER_ROUND;
   ...
   result["MUSE_BLOCKCHAIN_PRECISION"] = MUSE_BLOCKCHAIN_PRECISION;
   result["MUSE_BLOCKCHAIN_PRECISION_DIGITS"] = MUSE_BLOCKCHAIN_PRECISION_DIGITS;
   ...
   result["MUSE_LIQUIDITY_APR_PERCENT"] = MUSE_LIQUIDITY_APR_PERCENT;
   result["MUSE_LIQUIDITY_REWARD_BLOCKS"] = MUSE_LIQUIDITY_REWARD_BLOCKS;
   result["MUSE_LIQUIDITY_REWARD_PERIOD_SEC"] = MUSE_LIQUIDITY_REWARD_PERIOD_SEC;
   result["MUSE_LIQUIDITY_TIMEOUT_SEC"] = MUSE_LIQUIDITY_TIMEOUT_SEC;
   ...
   result["MUSE_MIN_LIQUIDITY_REWARD"] = MUSE_MIN_LIQUIDITY_REWARD;
   result["MUSE_MIN_LIQUIDITY_REWARD_PERIOD_SEC"] = MUSE_MIN_LIQUIDITY_REWARD_PERIOD_SEC;
   result["MUSE_MIN_PAYOUT_SBD"] = MUSE_MIN_PAYOUT_SBD;
   result["MUSE_MIN_POW_REWARD"] = MUSE_MIN_POW_REWARD;
