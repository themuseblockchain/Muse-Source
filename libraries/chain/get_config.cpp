...
fc::variant_object get_config()
{
   ...
   result["MUSE_APR_PERCENT_MULTIPLY_PER_BLOCK"] = MUSE_APR_PERCENT_MULTIPLY_PER_BLOCK_N;
   result["MUSE_APR_PERCENT_MULTIPLY_PER_DAY"] = MUSE_APR_PERCENT_MULTIPLY_PER_DAY_N;
   result["MUSE_APR_PERCENT_SHIFT_PER_BLOCK"] = MUSE_APR_PERCENT_SHIFT_PER_BLOCK_N;
   result["MUSE_APR_PERCENT_SHIFT_PER_DAY"] = MUSE_APR_PERCENT_SHIFT_PER_DAY_N;
