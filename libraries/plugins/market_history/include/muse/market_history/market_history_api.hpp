...
{
   public:
      market_history_api( const muse::app::api_context& ctx );

      void on_api_startup();

      /**
       * @brief Returns the market ticker for the internal MBD:MUSE market
       */
      ...
      /**
       * @brief Returns the current order book for the internal MBD:MUSE market.
      ...
      /**
       * @brief Returns the trade history for the internal MBD:MUSE market.
      ...
      /**
       * @brief Returns the N most recent trades for the internal MBD:MUSE market.
      ...
      /**
       * @brief Returns the market history for the internal MBD:MUSE market.
...
FC_API( muse::market_history::market_history_api,
   (get_ticker)
   (get_volume)
   (get_order_book)
   (get_trade_history)
