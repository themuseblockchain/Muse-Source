...
{
   using namespace muse::market_history;
   ...
   try
   {
      ...
      BOOST_REQUIRE( bucket->high_muse == ASSET( "1.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_mbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_muse == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_mbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_muse == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_mbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_muse == ASSET( "1.500 TESTS").amount );
      BOOST_REQUIRE( bucket->close_mbd == ASSET( "0.750 TBD" ).amount );
      BOOST_REQUIRE( bucket->muse_volume == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->mbd_volume == ASSET( "0.750 TBD" ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) );
      BOOST_REQUIRE( bucket->high_muse == ASSET( "0.500 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_muse == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_muse == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_muse == ASSET( "0.500 TESTS").amount );
      BOOST_REQUIRE( bucket->close_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->muse_volume == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->mbd_volume == ASSET( "0.250 TBD" ).amount );
      bucket++;

      BOOST_REQUIRE( bucket->seconds == 15 );
      BOOST_REQUIRE( bucket->open == time_a + ( 60 * 90 ) + 60 );
      BOOST_REQUIRE( bucket->high_muse == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_muse == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->open_muse == ASSET( "0.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->open_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->close_muse == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->muse_volume == ASSET( "0.950 TESTS" ).amount );
      BOOST_REQUIRE( bucket->mbd_volume == ASSET( "0.500 TBD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->close_muse == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->muse_volume == ASSET( "1.450 TESTS" ).amount );
      BOOST_REQUIRE( bucket->mbd_volume == ASSET( "0.750 TBD" ).amount );
      bucket++;
      ...
      BOOST_REQUIRE( bucket->open == MUSE_GENESIS_TIME );
      BOOST_REQUIRE( bucket->high_muse == ASSET( "0.450 TESTS " ).amount );
      BOOST_REQUIRE( bucket->high_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->low_muse == ASSET( "1.500 TESTS" ).amount );
      BOOST_REQUIRE( bucket->low_mbd == ASSET( "0.750 TBD" ).amount );
      ...
      BOOST_REQUIRE( bucket->close_muse == ASSET( "0.450 TESTS").amount );
      BOOST_REQUIRE( bucket->close_mbd == ASSET( "0.250 TBD" ).amount );
      BOOST_REQUIRE( bucket->muse_volume == ASSET( "2.950 TESTS" ).amount );
      BOOST_REQUIRE( bucket->mbd_volume == ASSET( "1.500 TBD" ).amount );
      bucket++;
